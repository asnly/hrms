			...
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-primary">
							...
							<form id="form2" class="form-horizontal" action="username_info_select.do">
								<table class="table table-condensed">
									...
									<tbody>
										<tr>
											<td><input type="checkbox" value="${employeeMap[key]}" name="ename">${employeeMap[key]}</td>
										</tr>
									</tbody>
									</#list>
									</#if>
									...
									<#list employee as em>
										<tbody>
										<tr>
											<td><input type="checkbox" value="${em.name}" name="ename">${em.name}</td>
										</tr>
									</tbody>
									</#list>
									-->
